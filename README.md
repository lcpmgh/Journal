...
![shiny_app_preview](https://raw.githubusercontent.com/lcpmgh/journal/master/preview.png)

===== 2026.08.08更新=====

+ 更新了数据，包括2019-2025年JCR索引数据、2026年新锐分区数据，都来自网络公开资料
+ 优化了部分代码
+ 删除了部分无用数据，只保留app依赖的最终版数据
